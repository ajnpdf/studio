...
import { FileIcon, ImageIcon, VideoIcon, MusicIcon, Replace, Info, Maximize2 } from 'lucide-react';
...
export function InputPanel({ file, onReplace }: Props) {
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-white/5 rounded-xl border border-white/5 space-y-1">
                ...
                <p className="text-xs font-bold">{file.metadata || 'N/A'}</p>
              </div>
              <div className="p-3 bg-white/5 rounded-xl border border-white/5 space-y-1">
                <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Modified</p>
                <p className="text-xs font-bold">{file.date}</p>
              </div>
            </div>
          </div>
