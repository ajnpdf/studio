      ...
      <main className="relative z-10 pt-32 pb-32">
        ...
        <section className="max-w-5xl mx-auto px-8 space-y-12 text-center mb-32">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-medium text-slate-950/60 max-w-2xl mx-auto leading-relaxed">
              Committed to delivering high-quality, secure, and efficient PDF solutions for everyone.
            </p>
          </motion.div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-8 mb-40">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
              ...
              <div className="relative aspect-square max-w-[400px] mx-auto rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white/60 group">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-6 bg-white/40 backdrop-blur-3xl rounded-[2rem] border border-white/60 shadow-2xl">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-xl font-black text-slate-950 tracking-tighter uppercase">AJN Core</p>
                      <p className="text-[9px] font-black text-primary uppercase tracking-widest mt-0.5">EST. 2026</p>
                    </div>
            ...
            >
              <div className="prose prose-slate max-w-none text-slate-950/80 font-medium space-y-10 leading-relaxed text-base md:text-lg uppercase tracking-widest">
                <p>
                  We built our PDF tools to make document conversion simple, fast, and reliable. Our goal is to help students and businesses streamline their work with easy, real-time PDF conversions.
                </p>
                <p>
                  Our platform offers professional and advanced features designed to save time and improve productivity. Whether you need to convert, edit, or manage documents, our tools provide accurate results with a smooth and user-friendly experience.
                </p>
                <p className="font-black text-slate-950">
                  We are committed to delivering high-quality, secure, and efficient PDF solutions for everyone.
                </p>
              </div>
              ...
              <div className="flex gap-6 pt-4">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-[8px] font-black text-slate-950/40 uppercase tracking-widest">Verified Secure</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section className="bg-white/40 backdrop-blur-3xl py-32 border-y border-black/5">
          <div className="max-w-6xl auto px-8">
            <div className="text-center space-y-4 mb-20">
              <h2 className="text-4xl font-black tracking-tighter uppercase text-slate-950">Core Values</h2>
              <p className="text-[10px] font-black text-slate-950/40 uppercase tracking-[0.4em]">The Standards of Excellence</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {[
                { icon: Zap, title: "Simplicity", desc: "Built to make document conversion simple, fast, and reliable." },
                { icon: ShieldCheck, title: "Reliability", desc: "Accurate results with a smooth and user-friendly experience." },
                { icon: Activity, title: "Efficiency", desc: "Designed to save time and improve productivity for everyone." }
              ].map((item, i) => (
                <div key={i} className="p-10 bg-white/60 rounded-[3rem] border border-black/5 shadow-xl space-y-6 hover:border-primary/20 transition-all group">
                  ...
                  <h3 className="text-2xl font-black tracking-tight text-slate-950 uppercase">{item.title}</h3>
                  <p className="text-[10px] font-bold text-slate-950/50 leading-relaxed uppercase tracking-widest">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
