...
export default function AJNPage() {
  ...
  return (
    <div 
      className="min-h-screen text-slate-950 selection:bg-primary/10 relative overflow-hidden font-body flex flex-col"
    ...
    >
      ...
      <header className="fixed top-0 left-0 right-0 h-16 border-b border-black/5 bg-white/40 backdrop-blur-xl z-[60] px-8 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-6">
          <Link href="/junction">
            <Button variant="outline" className="h-9 border-black/10 bg-white/50 hover:bg-primary hover:text-white font-black text-[10px] tracking-widest rounded-xl transition-all gap-2 px-4 shadow-sm text-slate-950">
          ...
          <div className="flex items-center gap-2 px-4 py-1.5 bg-white/5 rounded-xl border border-black/5">
            ...
            <span className="text-[10px] font-black text-slate-950/60 tracking-widest">Protocol Secured</span>
          </div>
        </div>
      </header>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center p-6 mt-24">
        ...
        <div className="w-full max-w-xl relative group animate-in fade-in slide-in-from-top-8 duration-1000 mb-10">
          ...
          <div className="relative flex items-center bg-white/60 backdrop-blur-3xl border border-black/10 rounded-[2rem] overflow-hidden shadow-2xl transition-all hover:border-primary/40">
            ...
            <input 
              ...
              className="w-full h-14 bg-transparent pl-16 pr-20 text-sm font-black text-slate-950 placeholder:text-slate-950/30 cursor-pointer outline-none"
            />
            ...
            <div className="w-full max-w-xl bg-white border border-black/5 rounded-[2rem] shadow-2xl overflow-hidden animate-in slide-in-from-top-4 duration-500">
              <div className="p-5 border-b border-black/5 relative flex items-center">
                ...
                <Input 
                  ...
                  className="h-14 pl-14 pr-12 bg-transparent border-none text-base font-black placeholder:opacity-30 focus-visible:ring-0 text-slate-950"
                />
                ...
                <div className="p-3 space-y-5">
                  {QUICK_UNITS.length > 0 ? (
                    ...
                    <div className="py-16 text-center space-y-3 opacity-40">
                      <Search className="w-10 h-10 mx-auto text-slate-950" />
                      <p className="text-[10px] font-black tracking-widest text-slate-950 uppercase">No Matching Service Units</p>
                    </div>
                  )}
                </div>
              </ScrollArea>
        ...
        <footer className="py-8 text-[9px] font-black text-slate-950/20 tracking-[0.4em] mt-auto animate-in fade-in duration-1000 delay-1000 uppercase">
